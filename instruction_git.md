...
Для загрузки данных в удаленный репозитариq сначала нужно к нему подключиться. Gользователь может создать собственный удаленный репозиторий на GitHub или другом подобном сервисе. Это занимает некоторое время, однако в дальнейшем полностью себя оправдывает, тем более, что подобные службы имеют пошаговые инструкции для правильно выполнения нужных действий.
...
<<<<<<< HEAD
=======
## Изменения названия основной ветки 
...
>>>>>>> 1cdb45a6412dcd92ac51bf603bcd9deb23c2bd61
